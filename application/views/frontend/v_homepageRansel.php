...
<head>
	...
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/bootstrap.min.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/normalize.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/font-awesome.min.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/icomoon.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/owl.carousel.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/bootstrap-select.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/scrollbar.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/jquery.mmenu.all.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/prettyPhoto.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/transitions.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/main.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/color.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets_frontend/css/css/responsive.css" rel="stylesheet">
...
<body class="tg-home tg-homevone">
					...
					<div class="tg-sliderarea">
						...
						<div class="tg-trendingtripsslider tg-trendingtrips owl-carousel">
							<!--<div class="item tg-trendingtrip">
								<figure>
									<a href="javascript:void(0);">
										<img src="<?php echo base_url().'assets/images/images/tours/img-05.jpg'?>" alt="image estinations">
										<div class="tg-hover">
							...
							<div class="item tg-trendingtrip">
								<figure>
									<a href="javascript:void(0);">
										<img src="<?php echo base_url().'assets/images/images/tours/img-05.png'?>"  alt="image destinations">
										<div class="tg-hover">
											<span class="tg-stars"><span></span></span>
											<span class="tg-tourduration">7 Days</span>
											<span class="tg-locationname">Paris</span>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="tg-toursdestinations">
								<div class="tg-tourdestination tg-tourdestinationbigbox">
									<figure>
										<a href="javascript:void(0);">
											<img src="<?php echo base_url().'assets/images/images/destination/img-01.jpg'?>" alt="image destinations">
	...
	*************************************-->
	...
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/bootstrap-select.min.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/jquery-scrolltofixed.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/owl.carousel.min.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/jquery.mmenu.all.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/packery.pkgd.min.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/jquery.vide.min.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/scrollbar.min.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/prettyPhoto.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/countdown.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/parallax.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/gmap3.js"></script>
	<script  src="<?php echo base_url(); ?>assets_frontend/js/js/main.js"></script>
</body>
</html>